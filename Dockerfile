...
COPY glide.yaml /go/src/github.com/deiscc/workflow-cli/
COPY glide.lock /go/src/github.com/deiscc/workflow-cli/

WORKDIR /go/src/github.com/deiscc/workflow-cli

RUN glide install --strip-vendor

COPY ./_scripts /usr/local/bin

COPY . /go/src/github.com/deiscc/workflow-cli
